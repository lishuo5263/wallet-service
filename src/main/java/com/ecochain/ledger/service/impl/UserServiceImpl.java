...
public class UserServiceImpl implements UserService {
    ...
    public boolean bindPhone(PageData pd, String versionNo) throws Exception {
        return (Integer)dao.update("com.ecochain.ledger.mapper.UsersDetailsMapper.bindPhone", pd)>0;
    }

    @Override
    public PageData getPhoneByAccount(String account, String versionNo) throws Exception {
        return (PageData)dao.findForObject("com.ecochain.ledger.mapper.UsersDetailsMapper.getPhoneByAccount", account);
    }
}
